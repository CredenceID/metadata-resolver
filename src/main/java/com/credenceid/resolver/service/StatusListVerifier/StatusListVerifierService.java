...
public class StatusListVerifierService {
     ...
     *
     * @param credentialStatus a list of `CredentialStatus` objects representing the credentialStatus
     ...
     */
    public List<StatusVerificationResult> verifyStatus(List<@Valid CredentialStatus> credentialStatus) {
        try {
            List<com.credenceid.vcstatusverifier.dto.StatusVerificationResult> statusVerificationResults = StatusVerifierService.verifyStatus(StatusListVerifierUtility.convertToDanubetechCredentialStatus(credentialStatus));
