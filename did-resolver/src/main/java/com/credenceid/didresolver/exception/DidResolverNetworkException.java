 ...
 * </p>
 */
public class DidResolverNetworkException extends Exception {

    private final String title;
    private final String detail;

    /**
     * Constructs a new {@code DidResolverNetworkException} with the specified title and detail.
     *
     * @param title  is title of the exception
     * @param detail is detail of the exception
     */
    public DidResolverNetworkException(String title, String detail) {
        this.title = title;
        this.detail = detail;
    }
